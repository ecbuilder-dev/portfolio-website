...
ESPERIENZE = [
    ...
    },
    {
        ...
        "descrizione": "Collaborazione nello sviluppo di souzioni software personalizzate per clienti aziendali, partecipando a tutte le fasi del ciclo di vita del software.",
    },
    {
